...
/*
    //Retrieve the values from the preferences

Gson gson = new Gson();

//From object to string
String objectToString = gson.toJson(device);

//From String to object
Device stringtoObject = gson.fromJson(objectToString, Device.class);


ArrayList<Device> devices = new ArrayList<Device>();

// Para utilizar la clase singleton nueva
Devices deviceList = Devices.getInstance();
ArrayList list = deviceList.getDeviceList();

// En una sola linea:
ArrayList finalList = Devices.getInstance().getDeviceList();


String jsonText = Prefs.getString("devices", null);
Device[] devices = gson.fromJson(jsonText, Device[].class);
...
devices.add(device);
        ...
        //List<String> textList = new ArrayList<String>();
        //textList.addAll(data);
        String jsonText = gson.toJson(devices);
        prefsEditor.putString("devices", jsonText);
        prefsEditor.commit();
